...
plot_data$outcome_time <- factor(plot_data$outcome_time,levels=c("at birth","first year","age 1 or 2","age 3 or 4","age 5, 6 or 7","age 8, 9 or 10","any time in childhood"),ordered=T)

...
dat$covs_ethnicityBIB_mother[raw_dat$eth0eth9gp=="White British"]<-"white british"
...
```{r eval=FALSE, include=TRUE}
datwb <- dat[which(dat$covs_ethnicityBIB_mother=="white british"),]
...
```{r eval=FALSE, include=TRUE}
#white british
datwb$anthro_birthweight_zscore <-scale(datwb$anthro_birthweight)
datwb$anthro_head_circ_birth_zscore <-scale(datwb$anthro_head_circ_birth)
datwb$anthro_crown_heel_birth_zscore <-scale(datwb$anthro_crown_heel_birth)

datwb$anthro_height_stage1_zscore <-scale(datwb$anthro_height_stage1)
datwb$anthro_height_stage2_zscore <-scale(datwb$anthro_height_stage2)
datwb$anthro_height_stage3_zscore <-scale(datwb$anthro_height_stage3)

datwb$anthro_weight_stage1_zscore <-scale(datwb$anthro_weight_stage1)
datwb$anthro_weight_stage2_zscore <-scale(datwb$anthro_weight_stage2)
datwb$anthro_weight_stage3_zscore <-scale(datwb$anthro_weight_stage3)

datwb$anthro_bmi_stage1_zscore <-scale(datwb$anthro_bmi_stage1)
datwb$anthro_bmi_stage2_zscore <-scale(datwb$anthro_bmi_stage2)
datwb$anthro_bmi_stage3_zscore <-scale(datwb$anthro_bmi_stage3)

datwb$anthro_head_circ_stage1_zscore <-scale(datwb$anthro_head_circ_stage1)
datwb$anthro_head_circ_stage2_zscore <-scale(datwb$anthro_head_circ_stage2)

datwb$anthro_waist_stage1_zscore <-scale(datwb$anthro_waist_stage1)
datwb$anthro_waist_stage2_zscore <-scale(datwb$anthro_waist_stage2)

datwb$covs_bmi_father_zscore <-scale(datwb$covs_bmi_father)
datwb$covs_bmi_mother_zscore <- scale(datwb$covs_bmi_mother)
...
saveRDS(datwb,"/Volumes/MRC-IEU-research/projects/ieu2/p5/015/working/data/bib/bib_wb_pheno.rds")
```

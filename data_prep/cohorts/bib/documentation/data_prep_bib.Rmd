...
```
NOTE THIS IS NOW OUT OF DATE! KEEPING IT SO WE CAN SEE WHAT WE WERE THINKING WITH CERTAIN BITS, BUT THE UPDATED VERSION OF THIS CODE IS NOW IN "bib_vars.r", "bib_derive.r" and "gen_genetic_data.r".
...
Fat mass index is available see bib_derive.r
...
dat$covs_asthma_mother_binary[raw_dat$prnprexconasthma=="Yes"]<-1
dat$covs_asthma_mother_binary[raw_dat$prnprexconasthma=="No"]<-0

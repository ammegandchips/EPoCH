...
hecm ?
dat$anthro_height_birth <- raw_dat$

#Waist circumference (cm)
#Weight (kg)

dat$anthro_weight_stage2 <- raw_dat$bpwgtk00
dat$anthro_weight_stage2[dat$anthro_weight_stage2<28]<-NA
dat$anthro_weight_stage2_zscore <- scale(dat$anthro_weight_stage2)

  ! # couldn't see these below weight measures variables in the documentation, but should make logical sense from the earlier measurement - GS may want to check
dat$anthro_weight_stage3 <- raw_dat$cpwgtk00
dat$anthro_weight_stage3[dat$anthro_weight_stage3<38]<-NA
dat$anthro_weight_stage3_zscore <- scale(dat$anthro_weight_stage3)

dat$anthro_weight_stage4 <- raw_dat$dpwgtk00
dat$anthro_weight_stage4[dat$anthro_weight_stage4<44]<-NA

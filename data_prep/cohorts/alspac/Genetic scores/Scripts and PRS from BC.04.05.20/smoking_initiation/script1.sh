...
#Extract the smoking SNPs from ALSPAC  
...
./script2.sh smoking_initiation_SNPs.txt /panfs/panasas01/shared/alspac/studies/latest/alspac/genetic/variants/arrays/gwas/imputed/1000genomes/released/2015-10-30/data/derived/filtered/bestguess/maf0.01_info0.8/data_chrCHR smoking_initiation \

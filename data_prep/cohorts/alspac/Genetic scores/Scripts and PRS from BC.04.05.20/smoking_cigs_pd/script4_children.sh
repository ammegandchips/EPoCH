...
#generate scores
 plink --file smoking_cigs_pd_children_excluded \
 		--noweb \
 		--score /panfs/panasas01/psyc/ke14426/epoch/smoking/smoking_cigs_pd/smoking_cigs_pd_betas.txt \
 		no-mean-imputation \
 		--out ${now}_scores_smoking_cigs_pd_children

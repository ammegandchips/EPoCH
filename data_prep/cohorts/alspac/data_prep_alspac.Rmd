...
## Description {.tabset}
This is the annotated code to prepare the ALSPAC dataset for use in EPoCH. To run this code, copy and paste the relevant sections. Or, you can extract all the code in this file (without the documentation) using:
```{r eval=FALSE, include=TRUE}
library(knitr)
purl("data_prep_alspac.Rmd")
```
You will then need to open it (e.g. in RStudio) and find and replace:

* "## ----eval=FALSE, include=TRUE---------------------------------------------------
" to blank
* "## " to blank

Then you can run the whole file using: source("data_prep_alspac.R") - this isn't the most efficient way of generating a phenotype file because we extract variables from the ALSPAC directory several times, but it does the job :)
...
dat$pb057[dat$pb060a==3]<-0#set decaf to 0 if say never drink decaf
dat$pb057[dat$pb060==3]<-0#set decaf to 0 if say never drink decaf
dat$pb057[dat$pb061<0]<-NA #set missing to NA in n decaf cups 
...
dat$pb057[dat$pb065a==3]<-0#set decaf to 0 if say never drink decaf
dat$pb057[dat$pb065==3]<-0#set decaf to 0 if say never drink decaf
dat$pb057[dat$pb066<0]<-NA #set missing to NA in n decaf cups 
...
dat$neuro_conduct_stage3_binary[dat$neuro_conduct_stage2>=3]<-1
dat$neuro_conduct_stage3_binary[dat$neuro_conduct_stage2<3]<-0
#Stage 4

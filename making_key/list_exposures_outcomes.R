...
all_exposures <- na.omit(c(smoking_exposures,alcohol_exposures,caffeine_exposures,physact_exposures))
...
fatmass_outcomes <-names(dat)[grep(names(dat),pattern="anthro_fmi")]
...
social_outcomes <-names(dat)[grep(names(dat),pattern="neuro_scdc")]
cognitive_outcomes <-names(dat)[grep(names(dat),pattern="neuro_cognition")]
cognitive_performance_outcomes <-names(dat)[grep(names(dat),pattern="neuro_cognition_performance")]
cognitive_verbal_outcomes <-names(dat)[grep(names(dat),pattern="neuro_cognition_verbal")]
